...
--
-- RELACIONES PARA LA TABLA `tbl_docentes`:
--
...
`ced_alumno` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Cedula o Rif del alumno',
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Tabla de detalles de facturas';
...
(1, '18293151', 'Emmanuel', 'Medina', '04125010803', 'correoalumno1@correo.xyz'),
(2, '17675633', 'Vanessa', 'Mambell', '04166113303', 'correoalumno2@correo.xyz'),
(3, '12345678', 'NombreAlumno3', 'ApellidoAlumno3', '04120987654', 'correoalumno3@correo.xyz'),
(4, '87654321', 'NombreAlumno4', 'ApellidoAlumno4', '04161234567', 'correoalumno4@correo.xyz'),
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Tabla de inscripcion';

--
-- Volcado de datos para la tabla `tbl_inscripcion`
--

--INSERT INTO `tbl_inscripcion` (`id_factura`, `numero_fact`, `fecha_fact`, `monto_fact`, `id_cliente`, `tiemporeg_fact`) VALUES
--(1, 1024, '2019-08-31', '10500.00', 1, '2019-08-31 21:46:21'),
--(2, 1025, '2019-08-31', '42000.00', 2, '2019-08-31 21:46:21'),
--(3, 1026, '2019-08-31', '128500.00', 1, '2019-08-31 21:46:21');
...
--
-- Filtros para la tabla `tbl_detalles_inscripcion`
--
--ALTER TABLE `tbl_detalles_facturas`
  --ADD CONSTRAINT `tbl_detalles_facturas_ibfk_1` FOREIGN KEY (`id_articulo`) REFERENCES `tbl_articulos` (`id_articulo`),
  --ADD CONSTRAINT `tbl_detalles_facturas_ibfk_2` FOREIGN KEY (`id_factura`) REFERENCES `tbl_facturas` (`id_factura`);

--
-- Filtros para la tabla `tbl_facturas`
--
--ALTER TABLE `tbl_facturas`
  --ADD CONSTRAINT `tbl_facturas_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `tbl_clientes` (`id_cliente`);
